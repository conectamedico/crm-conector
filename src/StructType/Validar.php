...
/**
 * This class stands for Validar StructType
 * Meta information extracted from the WSDL
 * - type: tns:Validar
 * @subpackage Structs
 */
class Validar extends AbstractStructBase
{
    /**
     * The crm
     * @var int
    ...
    public $chave;
    /**
     * Constructor method for Validar
     * @uses Validar::setCrm()
     * @uses Validar::setUf()
     * @uses Validar::setCpf()
     * @uses Validar::setDataNascimento()
     * @uses Validar::setChave()
     * @param int $crm
     * @param string $uf
     * @param string $cpf
     ...
     * Set crm value
     * @param int $crm
     * @return \ConectaMedico\Crm\StructType\Validar
     */
