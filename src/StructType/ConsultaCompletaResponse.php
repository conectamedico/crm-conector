...
/**
 * This class stands for ConsultaCompletaResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:ConsultaCompletaResponse
 * @subpackage Structs
 */
class ConsultaCompletaResponse extends AbstractStructBase
{
    /**
     * The dadosMedico
     * Meta information extracted from the WSDL
    ...
    public $dadosMedico;
    /**
     * Constructor method for ConsultaCompletaResponse
     * @uses ConsultaCompletaResponse::setDadosMedico()
